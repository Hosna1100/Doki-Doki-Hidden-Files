...
image bg classroom_day = "mod_assets/classroom_day.png"
...
define s = DynamicCharacter('s_name', image='سایوری', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
define m = DynamicCharacter('m_name', image='مانیکا', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
define n = DynamicCharacter('n_name', image='ناتسوکی', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
define y = DynamicCharacter('y_name', image='یوری', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
define trollface = DynamicCharacter('trollface_name', image='ترول فیس', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
...
default s_name = "سایوری"
default m_name = "مانیکا"
default n_name = "ناتسوکی"
default y_name = "یوری"
default trollface_name = "ترول فیس"
...
default trollface_poemappeal = [0, 0, 0]
...
default trollface_readpoem = False
